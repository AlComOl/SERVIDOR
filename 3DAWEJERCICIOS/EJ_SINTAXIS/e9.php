<!-- Dado el siguiente array  se tratará de visualizar todas las provincias (falta algunas), 
 aquellas menores de 500 rayos se mostrará en verde y de color rojo cuando sean mayores, también deberá mostrarse el
  total acumulado. -->
<?php
  $comunidades = array(
...
foreach ($comunidades as $comunidad) {
  ...
  foreach ($comunidad as $key => $value) {
   ...
   echo"<strong><em> Casos totales en  ". $comunidad['comunidad']. "  :  " .$t ."</em></strong><br>";
}
